$(function(){
    ...
    $("#formRegister").validate({
        ...
        submitHandler: function(form) {
            ...
            var data = {username:$("input[name=username]").val(), password:$("input[name=password]").val(), reg_num:$("input[name=reg_number]").val()};
            data = JSON.stringify(data);
            
            $.ajax({
                url: 'https://api.olyvhealth.com/register',
                type: 'POST',
                data: data,
...
function fakeLogin(){
    ...
    data = JSON.stringify(data);
    $.ajax({
        url: 'https://api.olyvhealth.com/login',
        type: 'POST',
        data: data,
        success: function(response) {
            if(response.error == undefined){
